  ...
  return (
    <div className="min-h-screen pt-20 pb-16 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10 fade-in-up">
        ...
        {/* Chat Float & Export */}
        <div className="mt-12 flex flex-col md:flex-row items-center justify-center gap-6 hide-on-print">
          <a
          ...
          <button
            onClick={() => {
              window.open(`${API}/api/pipeline/export/${sessionId}?format=excel`, "_blank");
            }}
            className="group relative inline-flex items-center gap-2 px-6 py-4 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full text-white font-bold text-base shadow-lg backdrop-blur-sm transition-all transform hover:-translate-y-1"
          >
             <span className="text-xl">📊</span>
             <span>Download ITR-1 Excel</span>
          </button>
          
          <button
            onClick={() => {
              window.open(`${API}/api/pipeline/export/${sessionId}?format=pdf`, "_blank");
            }}
            className="group relative inline-flex items-center gap-2 px-6 py-4 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full text-white font-bold text-base shadow-lg backdrop-blur-sm transition-all transform hover:-translate-y-1"
          >
             <span className="text-xl">📄</span>
